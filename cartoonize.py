####################
# This file is use to interact with CartoonGAN module and produces cartoonized image.
# It is adapted from the demo of originial CartoonGAN repository.
